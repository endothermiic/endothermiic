...
Prestige Tutoring \hfill \textit{Vaughan, ON} 
\vspace{-0.2cm}
\begin{itemize}
   \item Developing lessons for neurodiverse students (grades 3-12) with parental input
   \item  Have improved student scores by up to 25\% in calculus, algebra, functions, chemistry, physics and elementary math
\end{itemize}
\end{rSection} 
...
\vspace{-1.25em}
\item \textbf{Sauna Redesign:} Designed a \href{https://docs.google.com/presentation/d/1E1__1gkfL-J-T4yYeGk8QzZPa56Gy8qQq15TEvjyjhc/edit?usp=sharing}{fully off-grid sauna} in Rhino/Photoshop for Concord Investments' President David Delaney; Milestones followed a waterfall methodology and were tracked in Microsoft Project.
\item \textbf{Manhattan Plots:} {Performed a GWAS (\href{https://my.locuszoom.org/gwas/482189/}{generated plots}) to determine single nucleotide polymorphisms influencing ERAP-2 expression in Utah residents with EU ancestry and
...
\begin{rSection}{SKILLS}
   ...
   Languages & C/C++, Python, MATLAB, R, \LaTeX  \\
   Frameworks & Pytorch, TensorFlow \\ 
   Web Development & HTML, CSS, JavaScript\\ 
   PCB Design \& CAD & AutoCAD, Rhino, Altium, LTSpice
...
\begin{rSection}{EDUCATION}
    ...
    \begin{itemize}
     \itemsep -8pt {} 
      ...
      \item  Hardware Lead @ UofT iGEM, ECE Mentorship Program
    \end{itemize}

    {\bf Semester Abroad}, University of Siena \hfill {Summer 2023}
    \vspace{-0.2cm}
    \begin{itemize}
     \itemsep -8pt {} 
      \item  Summer Abroad outreach coordinator
      \item  \href{https://github.com/endothermiic/serendipity}{Static website} documenting the experience in progress
    \end{itemize}
